...
const planCopy: Record<string, { speed: string; label: string }> = {
  Weekly: { speed: "20 Mbps", label: "For flexible routines" },
  Monthly: { speed: "25 Mbps", label: "Best value" },
}
